...
public final class KdIntentManager {
    /**
     * is normal start
     */
     ...
     * instance
     */
    private static KdIntentManager sInstance;

    /**
     * @return instance
     */
    public static synchronized KdIntentManager getInstance() {
        if (sInstance == null) {
            sInstance = new KdIntentManager();
        }
        return sInstance;
    }
