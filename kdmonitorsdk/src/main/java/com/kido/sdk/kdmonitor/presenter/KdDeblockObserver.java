 ...
 * DeblockObserver
 */
public class KdDeblockObserver extends BroadcastReceiver {
     ...
     * StatLog TAG
     */
    private static final String StatLog_TAG = KdDeblockObserver.class.getSimpleName();
    /**
     * Context
     */
     ...
     */
    public KdDeblockObserver(Context aContext, IKeyguardListener aListener) {
        mContext = aContext;
        mListener = aListener;
    }
    ...
    public void onReceive(Context aContext, Intent aIntent) {
        if (KdIntentManager.getInstance().isUserPresentIntent(aIntent)) {
            if (mListener != null) {
