package com.kido.sdk.kdmonitor.db;
...
public class KdNote {
    ...
    public KdNote(Long id) {
        this.id = id;
    }

    public KdNote(Long id, String firstCloumn, String secondCloumn, String thirdCloumn, String forthCloumn) {
        this.id = id;
