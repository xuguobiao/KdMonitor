...
public final class StatLog {
     ...
     * folder name
     */
    private static String mFolderName = Environment.getExternalStorageDirectory() + File.separator + "KdMonitorSdk"
            + File.separator + "StatLog" + File.separator + "log" + File.separator;
    /**
     * log file name
     */
    private static String mLogFileName = mFolderName + "KdMonitorStat_log.txt";
    /**
     * 当前log
     */
    private static String mLogFileNameLogcat = mFolderName + "KdMonitor_lasttime_log.txt";
